...
#Pmod Header JXADC
#Sch name = XA1_P
set_property PACKAGE_PIN J3 [get_ports {VAUX1}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VAUX1}]

##Sch name = XA1_N
set_property PACKAGE_PIN K3 [get_ports {VAUX2}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VAUX2}]
##Sch name = XA2_N
